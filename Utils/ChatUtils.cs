...
namespace Torch.SharedLibrary.Utils
{
    public static class ChatUtils
    {
        ...
        public static void SendTo(long playerId, string message, string from = "", string color = Constants.DEFAULT_CHAT_MESSAGE_COLOR)
        {
        ...
        /// <param name="from">Who is sending the message</param>
        /// <param name="color">Color used for the message</param>
        public static void SendTo(long playerId, StringBuilder message, string from = "", string color = Constants.DEFAULT_CHAT_MESSAGE_COLOR)
        {
        ...
        /// <param name="from">Who is sending the message</param>
        /// <param name="color">Color used for the message</param>
        public static void SendToAll(string message, string from = "", string color = Constants.DEFAULT_CHAT_MESSAGE_COLOR)
        {
        ...
        /// <param name="from">Who is sending the message</param>
        /// <param name="color">Color used for the message</param>
        public static void SendToAll(StringBuilder message, string from = "", string color = Constants.DEFAULT_CHAT_MESSAGE_COLOR)
        {
